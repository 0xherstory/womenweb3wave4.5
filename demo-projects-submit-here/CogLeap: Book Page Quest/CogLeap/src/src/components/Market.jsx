  ...
  return (
    <div className="bg-dark-800/70 backdrop-blur-md rounded-lg border border-web3-primary/30 p-6 mt-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <button className="text-web3-primary hover:text-web3-primary/80 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {marketItems.map(item => (
          <div key={item.id} className={`bg-dark-700/60 rounded-lg p-4 border ${item.borderColor} transition-all duration-300 flex flex-col`}>
            <div className="relative mb-3 flex-grow flex items-center justify-center">
              <div className={`w-full h-32 rounded-lg bg-dark-800/50 flex items-center justify-center`}>
                <i className={`fa ${item.icon} ${item.textColor} text-5xl`}></i>
              </div>
            ...
            <div className="text-center">
              <div className={`${item.textColor} font-medium mb-2`}>{item.name}</div>
            ...
            <div className="flex justify-between items-center mt-auto">
              ...
              <button 
                ...
                className="bg-web3-primary/20 hover:bg-web3-primary/30 text-web3-primary text-xs px-3 py-1 rounded transition-colors"
              >
                购买
              </button>
            </div>
