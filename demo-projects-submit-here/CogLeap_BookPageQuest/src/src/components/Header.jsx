...
const Header = ({ isAuthenticated, handleLogin, handleLogout, walletAddress, handleOpenDashboardModal, handleOpenThinkingToolsModal }) => {
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="relative">
          <div id="profilePic" className="w-10 h-10 rounded-full bg-dark-700 border-2 border-neon-purple flex items-center justify-center overflow-hidden">
            <img src={`https://api.dicebear.com/7.x/micah/svg?seed=${walletAddress || 'default'}`} alt="玩家头像" className="w-full h-full object-cover" />
          </div>
          {isAuthenticated && (
